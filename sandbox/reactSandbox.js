...
function App() {
  ...
  return (
    <div>
      <SkulletorSample end={dataReady} onDisapear={() => {
        console.log('passe')
        setLoading(false)}} />
    </div>
  )
